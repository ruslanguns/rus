...
import { ApolloAngularSDK } from '@rus/web/core/data-access'
import { environment } from '@rus/web/core/feature'
...
export class WebAboutFeatureComponent {
  ...
  uptime$ = this.sdk.uptimeWatch(null, { pollInterval: 1000 }).valueChanges.pipe(map((res) => res?.data?.uptime))
